...
module.exports = {
  ...
  Lesson03: {
    ...
    DID_NOT_USE_CONDITIONALS: "O seu código deve usar condicionais neste nível (por exemplo, 'se eng {G}' é um código com um condicional). Leia as instruções e veja a referência de comandos para entender como fazer.",
  },
